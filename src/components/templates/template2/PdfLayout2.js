...
class PdfLayout2 extends Component {
            ...
            <div className="resume-template1">
              <table className="main w-100" style={{ marignBottom: "20px" }}>
                <thead>
                  <tr>
                    <td
                      className={
                        this.props.image === null ? "hide" : "bodyImg img w-15"
                      }
                    >
              ...
              <div className="outer w-100">
                <div className="leftSide">
                  <table className="section text-left w-95">
                  ...
                  <table
                    className={
                      this.props.awardBlocks.length > 0
                        ? "w-100 section"
                        : "hide"
                    }
                  >
...
export default connect(mapStateToProps)(PdfLayout2);
